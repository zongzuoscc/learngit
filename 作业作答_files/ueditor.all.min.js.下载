	...
	(function() {
		...
		Editor.prototype = {
			...
			pureWordCount : function() {//计算输入的纯字数
				var detectedWords = this.pureWord();
				...
				me.body.ondrop = function (event) {
					try{
						...
						for(var i = 0 ; i < files.length;i++){
							uploadImageAndInsertFile(files.item(i),me);
						}
					}catch(err){}
					return false;
				};
...
//    }
	...
	(function() {
		...
		var iframeUrlMap = {
			...
			'insertimage' : '~/dialogs/image/imageNew.html?v=2023-0517-1120' + '#'
			...
			'attachment_new' : '~/dialogs/attachment_new/attachment.html?v=2023-0718-2033' + '#'
					+ window.UEDITOR_CONFIG.DIYDOMAIN,
			'symbol' : '~/dialogs/symbol/symbol.html' + '#'
					+ window.UEDITOR_CONFIG.DIYDOMAIN,
			'tpupload' : '~/dialogs/tpupload/tpupload.html?v=2023-0628-1840' + '#'
				+ window.UEDITOR_CONFIG.DIYDOMAIN,
			'mathml' : '~/dialogs/mathml/mathml.html?v=2023-0718-2100' + '#'
					+ window.UEDITOR_CONFIG.DIYDOMAIN,
		    'edrawmath' : '~/dialogs/edrawmath/edrawmath.html' + '#'
                 	+ window.UEDITOR_CONFIG.DIYDOMAIN,		
           'calculator' : '~/dialogs/calculator/index.html' + '#'
                 	+ window.UEDITOR_CONFIG.DIYDOMAIN,		
           'drawingboard' : '~/dialogs/drawingboard/index.html?v=2023-0718-1700' + '#'
			...
			'audio' : '~/dialogs/audio/attachmentNew.html?v=2023-0517-1120' + '#' + window.UEDITOR_CONFIG.DIYDOMAIN
		};
		var btnCmds = [ 'undo', 'redo', 'formatmatch', 'bold', 'italic',
				...
				'tpupload', 'symbol', 'mathml','edrawmath','calculator','drawingboard','insertcodedefined'];
		...
		var dialogBtns = {
			...
			ok : [ 'attachment', 'anchor', 'link', 'insertimage', 'map',
					...
					'symbol', 'mathml','recording','audio','edrawmath','calculator','drawingboard']
		};
		var dialogNoBottomBtns=['recording','attachment_new', 'insertimage', 'audio', 'tpupload','edrawmath','calculator','drawingboard'];//设置对话框不显示底部按钮
		...
		UE.ui.Editor = function(options) {
			...
			utils.loadFile(document, {
				href : editor.options.themePath + editor.options.theme
						+ "/css/ueditor.css?v=2023-0613-1428",
				tag : "link",
				type : "text/css",
				rel : "stylesheet"
			});
